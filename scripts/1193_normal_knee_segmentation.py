...
# def debug_draw_radial_masks():
    """Sub-script to debug new radial mask function on a smaller dataset"""
...
#     # Estimate femur tip 
#     femur_tip_ = rdl.estimate_femur_tip_boundary(femur_boundary, 0.6)
#     # femur_tip_ = rdl.filter_outlier_points_centroid(femur_tip_, 100) # Not necessary with manual refinements 
#     # views.draw_points(video, femur_tip_) # Validate results
