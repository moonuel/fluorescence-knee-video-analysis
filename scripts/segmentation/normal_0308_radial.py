...
class normal308(KneeSegmentationPipeline):
    ...
    def radial_segmentation(self, mask=None, femur_mask=None, n_lines=128, n_segments=64, tip_range=(0.05, 0.45), midpoint_range=(0.6, 0.9), smooth_window=9, inplace=False):
