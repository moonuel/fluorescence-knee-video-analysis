...
class Normal0001Pipeline(KneeSegmentationPipeline):
    ...
    def generate_otsu_mask(self, video=None, blur_kernel=(25,25), thresh_scale=0.5, hist_frame=78, inplace=False):
    ...
    def refine_femur_mask(self, mask=None, morph_open_kernel=None, morph_close_kernel=(11,11), morph_erode_kernel=None, morph_dilate_kernel=None, inplace=False):
...
if __name__ == "__main__":
    pipeline = Normal0001Pipeline(r"data\raw\right before_00000001.npy", "0001", "normal")
