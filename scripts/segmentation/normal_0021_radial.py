...
class Normal0021Pipeline(KneeSegmentationPipeline):
    
    def preprocess(self, video=None, rot90_k=1, rot_angle=-12, crop_size=500, empty_fill_value=17, inplace=False):
        return super().preprocess(video, rot90_k, rot_angle, crop_size, empty_fill_value, inplace)
    
    def generate_otsu_mask(self, video=None, blur_kernel=(25,25), thresh_scale=0.5, hist_frame=180, inplace=False):
    ...
    def generate_interior_mask(self, hist_video=None, adaptive_block=167, adaptive_c=11, inplace=False):
    ...
    def refine_femur_mask(self, mask=None, morph_open_kernel=None, morph_close_kernel=None, morph_erode_kernel=None, morph_dilate_kernel=None, inplace=False):
        ...
        # Fill MCL gap
        mask[:, 323:357, 210:340] = 255 # Box from (x,y)=(219,313) to (x,y)=(311,337)
...
if __name__ == "__main__":
    pipeline = Normal0021Pipeline(r"data\raw\right before_00000021.npy", "0021", "normal")
