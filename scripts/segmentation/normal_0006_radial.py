...
class Normal0006Pipeline(KneeSegmentationPipeline):
    ...
    def generate_otsu_mask(self, video=None, blur_kernel=(25,25), thresh_scale=0.5, hist_frame=60, inplace=False):
    ...
    def refine_femur_mask(self, mask=None, morph_open_kernel=None, morph_close_kernel=None, morph_erode_kernel=None, morph_dilate_kernel=None, inplace=False):
        ...
        # Fill MCL gap
        mask[:, 303:337, 210:340] = 255 # Box from (x,y)=(219,313) to (x,y)=(311,337)
...
if __name__ == "__main__":
    pipeline = Normal0006Pipeline(r"data\raw\right before_00000006.npy", "0006", "normal")
