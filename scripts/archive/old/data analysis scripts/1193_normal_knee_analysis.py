...
def main():
    ...
    video = io.load_nparray("../data/segmented/normal_1193_radial_video_N16.npy")#[1700:1750]
    radial_masks = io.load_nparray("../data/segmented/normal_1193_radial_masks_N16.npy")#[1700:1750]
